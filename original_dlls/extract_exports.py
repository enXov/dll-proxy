...
def generate_header(dll_name, exports, original_path=None):
    """
    ...
    Args:
        ...
        original_path: Custom path to original DLL (default: C:\\Windows\\System32\\)
    ...
    # Default to System32 if no custom path provided
    if original_path is None:
        original_path = f"C:\\\\Windows\\\\System32\\\\{dll_name}"
    else:
 ...
 * Original DLL Path: {original_path.replace(chr(92)+chr(92), chr(92))}
 * 
 * Usage:
...
"""
    ...
    for func_name, ordinal in exports:
        # Format: #pragma comment(linker, "/EXPORT:GetFileVersionInfoA=C:\\Windows\\System32\\version.dll.GetFileVersionInfoA,@1")
